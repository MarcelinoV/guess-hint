...
# This first part of the code randomly selects a word & its hint (key:value)
# from the word_bank, which is a dictionary. It then prints the hint and intro
# message
...
# This second part of the code creates the game itself and its functions,
# including a guess limit and guess count
...
# I originally learned the guessing game when I was first learning python with freeCodeCamp on Youtube,
# but here I've expanded on it with the word bank code. Credits to freeCodeCamp for the inspiration.
